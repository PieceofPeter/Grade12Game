...
public class Level2 extends JPanel implements ActionListener, KeyListener {
    ...
    public Level2() {
        ...
        for (int i = 0; i < 3; i++) {
            backgroundImages[i] = new ImageIcon("SPRITES\\background2" + i + ".png").getImage();
        }
        ...
        // Load music
        try {
            File musicFile = new File("SPRITES\\leveltwo.wav");
    ...
    public void paintComponent(Graphics g) {
        ...
        g.setColor(Color.BLACK);
        g.setFont(new Font("Press Start 2P", Font.BOLD, 35));
        g.drawString("LEVEL TWO", 175, 100);

        g.drawImage(lava,0, 820, 1720, 180, this);
        
        for (int i=30;i < 1500;i=i+450) {
            g.drawImage(platformImage1, i, 550,200,500, this);
        }
        
        g.drawImage(platformImage1, 1200, 600,200,500, this);
               
        g.drawImage(endFlagImage, 1500, 290, 150, 300, this);
        g.drawImage(spikes, 1250 ,525, 100, 100, this);
        g.drawImage(spikes, 550 ,535, 50, 50, this);
...
// Handle player movement
    ...
    private void checkCollisions() {
        ...
        Rectangle spikeRect = new Rectangle(1250 ,575, 100, 50);
        Rectangle spikeRect2 = new Rectangle(550 ,535, 50, 50);
        ArrayList<Rectangle> platforms = new ArrayList<>();

        for (int i=30;i < 1500;i=i+450) {
            platforms.add(new Rectangle(i, 550, 200, 450));
        }
        ...
        if (spikeRect2.intersects(playerRect)) {
            levelEnded = true;
            musicClip.stop();
            moveSoundClip.stop();
            DeadScreen.main(null);
