...
public class Level1 extends JPanel implements ActionListener, KeyListener {
    ...
    public Level1() {
        ...
        for (int i = 0; i < 3; i++) {
            backgroundImages[i] = new ImageIcon("SPRITES\\background1" + i + ".png").getImage();
        }
        ...
        // Load music
        try {
            File musicFile = new File("SPRITES\\levelone.wav");
    ...
    public void paintComponent(Graphics g) {
        ...
        g.setColor(Color.BLACK);
        g.setFont(new Font("Press Start 2P", Font.BOLD, 35));
        g.drawString("LEVEL ONE", 175, 100);

        g.drawImage(lava,0, 820, 1720, 180, this);
        
        g.drawImage(endFlagImage, 1500, 400, 150, 300, this);
        g.drawImage(spikes, 950,590 , 60, 100, this);
               
        for (int i=30;i < 1500;i=i+430) {
...
// Handle player movement
    ...
    private void checkCollisions() {
        ...
        Rectangle spikeRect = new Rectangle(950,620, 60, 75);
        ArrayList<Rectangle> platforms = new ArrayList<>();

        for (int i = 0; i < 1720; i +=   215) {
            platforms.add(new Rectangle(i, 660, 200, 450));
        }
